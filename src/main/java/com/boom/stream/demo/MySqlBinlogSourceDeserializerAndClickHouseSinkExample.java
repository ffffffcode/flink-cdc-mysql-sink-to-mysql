 ...
 */
public class MySqlBinlogSourceDeserializerAndClickHouseSinkExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.fromSource(mySqlSource, WatermarkStrategy.noWatermarks(), "MySQL bm_order Source")
                ...
                .addSink(JdbcSink.sink(
                        "INSERT INTO analyse.user_behavior_flink_cdc (tenant_id, area_id, member_id, event_time, behavior_type) VALUES (?, ?, ?, ?, ?)",
                        (ps, t) -> {
                        ...
                        new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                                ...
                                .build()))
                .name("ClickHouse user_behavior_flink_cdc Sink")
                .setParallelism(2);

        env.execute("Sink UserBehavior(ClickHouse)");
    }
